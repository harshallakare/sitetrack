...
import { ShieldCheck, LayoutDashboard, Building2, Users, ArrowLeft, Bell, CreditCard, Database, Tag } from "lucide-react";
    ...
    <div className="min-h-screen">
      <header className="border-b border-red-900/30 bg-neutral-950 text-neutral-100">
        ...
        <nav className="mx-auto flex max-w-6xl gap-1 px-4 pb-2 md:px-6">
          ...
          <AdminNavLink href="/admin/plans" icon={Tag} label="Plans" />
